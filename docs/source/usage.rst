...
Some common metadata fields are shown in the table below, with their definitions.
...
.. table:: Metadata Fields
   ...
   +==================+========================================+==========================================+
   | Autogenerated    | ``experiment_uuid``                    | A universal unique identifier (UUID)     |
   |  (do not edit)   |                                        | for the current experiment.              |
   +------------------+----------------------------------------+------------------------------------------+
   | Autogenerated    | ``name``                               | The experiment name used for the work    |
   |   (may edit)     |                                        | and archive directories.                 |
   +                  +----------------------------------------+------------------------------------------+
   |                  | ``created``                            | The creation date of the experiment in   |
   |                  |                                        | ``YYYY-MM-DD`` format.                   |
   +                  +----------------------------------------+------------------------------------------+
   |                  | ``model``                              | The name of the model being run (e.g.,   |
   |                  |                                        | ``ACCESS-OM3``, ``ACCESS-ESM1.5``).      |
   +                  +----------------------------------------+------------------------------------------+
   |                  | ``contact``                            | The name of the person running the       |
   |                  |                                        | current experiment. Automatically        |
   |                  |                                        | populated from git configuration         |
   |                  |                                        | (``user.name``).                         |
   +                  +----------------------------------------+------------------------------------------+
   |                  | ``email``                              | The email address of the experiment      |
   |                  |                                        | contact. Automatically populated from    |
   |                  |                                        | git configuration (``user.email``).      |
   +                  +----------------------------------------+------------------------------------------+
   |                  | ``url``                                | The URL of the git repository origin.    |
   +                  +----------------------------------------+------------------------------------------+
   |                  | ``parent_experiment``                  | The UUID of the parent experiment, if    |
   |                  |                                        | this experiment branches from another.   |
   +                  +----------------------------------------+------------------------------------------+
   |                  | ``parent_experiment_branch_time``      | The model time corresponding to the      |
   |                  |                                        | restart path used to create this branch. |
   +                  +----------------------------------------+------------------------------------------+
   |                  | ``parent_experiment_branch_commit``    | The Git commit hash of the source branch |
   |                  |                                        | when the new branch was created.         |
   +                  +----------------------------------------+------------------------------------------+
   |                  | ``schema_version``                     | The version of the ACCESS-NRI metadata   |
   |                  |                                        | schema used for this experiment.         |
   +------------------+----------------------------------------+------------------------------------------+
