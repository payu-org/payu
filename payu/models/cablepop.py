...
class CablePOP(Model):
    ...
    def __init__(self, expt, name, config):
        ...
        self.model_type = 'cablePOP'
        self.default_exec = 'cable'

        self.config_files = ['cable.nml', 'cru.nml', 'luc.nml',
                             'met_names.nml', 'stage_config.yaml']
    ...
    def archive(self):
        """Store model output to laboratory archive and update the configuration
        log."""
