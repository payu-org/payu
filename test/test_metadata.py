...
def test_metadata_off_env_var_flag():
    # Set metadata to True in config file
    write_config(config)

    # Set PAYU_METADATA_OFF to True. This environment variable is
    # passed to PBS submission jobs
    os.environ['PAYU_METADATA_OFF'] = 'True'
    ...
    # Remove PAYU_METADATA_OFF flag
    del os.environ['PAYU_METADATA_OFF']
